export const publications = [
  {
    ...
    venue: "CHI LBW 2024",
    summary:
      "Developed an LLM+RAG-based clinical note management system for chart summarization and retrieval; improved efficiency of clinician workflows.",
    description:
  ...
  },
  {
    ...
    venue: "CHI LBW 2024",
    summary:
      "Conducted UX study comparing text-to-audio generation with search-based music selection; proposed design guidelines and prototyped an LLM-assisted prompt system.",
    description:
...

  {
    id: 3,
    title:
      "MoodChartBot: Design and Implementation of a Mood Chart Application Using AI Chatbot.",
    venue: "Journal of Korea Multimedia Society",
    summary:
      "Designed chatbot-based mood tracking app using KoBERT for emotion detection; supported early detection of depressive symptoms.",
    description:
